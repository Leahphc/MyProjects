...
def get_best_pixel(pixels):
    ...
    """
    avg = {}
    avg['RED'] = get_average(pixels)[0]
    avg['GREEN'] = get_average(pixels)[1]
    avg['BLUE'] = get_average(pixels)[2]
    ...
    for pixel in pixels:
        ...
        dist_lst.append(get_pixel_dist(pixel, avg['RED'], avg['GREEN'], avg['BLUE']))

    min_dist = dist_lst.index(min(dist_lst))
    best_pixel = pixels[min_dist]
